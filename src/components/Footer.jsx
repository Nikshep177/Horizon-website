        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li><Link to="/qiskit">Qiskit</Link></li>
          ...
          <div className="footer-section social">
            ...
            <ul>
              <li>
                <ExternalLink href="https://www.instagram.com/horizoniitm/">
              ...
              <li>
                <ExternalLink href="https://www.youtube.com/@HorizonIITM">
              ...
              <li>
                <ExternalLink href="https://www.linkedin.com/company/horizon-cfi-iitm/">
